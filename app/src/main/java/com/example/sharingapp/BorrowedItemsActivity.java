...
public class BorrowedItemsActivity extends AppCompatActivity implements Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item_list_controller.setItems(item_list_controller.getBorrowedItems(username));
        ...
        borrowed_items.setOnItemLongClickListener(new android.widget.AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int pos, long id) {
                ...
                item_list_controller.loadItems(context); // must load users again here
                item_list_controller.setItems(item_list_controller.getBorrowedItems(user_id));
