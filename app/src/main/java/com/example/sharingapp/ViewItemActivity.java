...
public class ViewItemActivity extends AppCompatActivity implements Observer {
    ...
    private Bid bid;
    private BidController bid_controller;
    ...
    String height_str;
    String user_id;
    String current_bid_amount_str;
    String new_bid_amount_str;
    String item_id;

    Float new_bid_amount;
    Float current_bid_amount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        on_create_update = false; // suppress any further calls to update() // TODO may change this.
    }
    ...
    public void saveBid(View view) {
        ...
        // current bid amount must be higher than the previous bid
        if(!validateInput()){
            return;
        }
        ...
        bid = new Bid(item_id, new_bid_amount, username);
    ...
    public void returnItem(View view) {
        ...
        intent.putExtra("user_id", user_id);
        Toast.makeText(getApplicationContext(), "Item returned.", Toast.LENGTH_SHORT).show();
        startActivity(intent);
    ...
    public boolean validateInput(){
        ...
        current_bid_amount = Float.valueOf(current_bid_amount_str);
